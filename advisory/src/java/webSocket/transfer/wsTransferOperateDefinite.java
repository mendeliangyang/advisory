 ...
 */
public class wsTransferOperateDefinite {

    public static final String Operate_createRoom = "createRoom";
    ...
    public static final String Operate_getOnlineUser = "getOnlineUser";
    public static final String Operate_signOutNotify = "signOutNotify";
    public static final String Operate_signInNotify = "signInNotify";
